...
<div class="container">
  <div class="row" style="margin-bottom: 50px; margin-top: 50px;">
    <div class="col text-center">
      <h1 class="text-success"><strong>FORM TAMBAH DATA ADMIN</strong></h1>
      <hr>
    </div>
  </div>
<!-- FORM -->
...
<form action="proses_tambah_admin.php" method="post"> 
  <div class="form-row">
    ...
    <div class="form-group col-md-8">
      <input type="text" class="form-control" id="inputNama" name="namaLengkap" placeholder="Masukkan Nama Lengkap" required>
    </div>
  </div>
  <div class="form-row">
    <div class="form-group col-md-4">
  ...
  <div class="form-row">
      <button type="submit" class="btn btn-tambah">TAMBAH ADMIN</button>
  </div>
  </form>
  </div>
</div>
