    ...
    <div class="col text-center box-login">
      <div class="card text-center">
        <div class="card-header">
          <h1 style="color: #808080;">LOGIN</h1>
        </div>
        ...
        ?>
          ...
          <div class="form-row">
            <div class="form-group col-md-4">
              <label for="inputPassword" style="color: #808080;"><strong>PASSWORD</strong></label>
            </div>
            <div class="form-group col-md-6">
              <input type="password" class="form-control" id="inputPassword" name="password" >
            </div>
          </div>
          <button type="submit" form="login" class="btn btn-info">LOG IN</button>
        </div>
        </form>
        <div class="card-footer text-muted">
          <a href="lupa_password.php" style="color: #808080">Lupa Password?</a>
        </div>
      </div>
    </div>
  </div>
